...
const skills = [
  { name: "HTML", Icon: SiHtml5, percent: 99 },
  { name: "CSS", Icon: SiCss3, percent: 99 },
  { name: "Tailwind", Icon: SiTailwindcss, percent: 97 },
  { name: "JavaScript", Icon: SiJavascript, percent: 95 },
  { name: "TypeScript", Icon: SiTypescript, percent: 90 },
  { name: "React", Icon: SiReact, percent: 95 },
  { name: "Next.js", Icon: SiNextdotjs, percent: 90 },
  { name: "Node.js", Icon: SiNodedotjs, percent: 90 },
  { name: "Supabase", Icon: SiSupabase, percent: 90 },
  ...
  { name: "Git-GitHub", Icon: SiGithub, percent: 99 },
